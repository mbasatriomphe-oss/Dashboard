...
const adminNavigation = [
  ...
  { name: "Attributs", href: "/admin/attributs", icon: PackagePlus },
  { name: "Modèles des attributs", href: "/admin/attributs-templates", icon: PackagePlus },
  { name: "Variantes", href: "/admin/variantes", icon: PackagePlus },
