      ...
      <div className="flex-1 overflow-auto p-3 sm:p-4">
        {cart.length === 0 ? (
          ...
          <div className="space-y-3">
            {cart.map((item) => (
              <div key={`${item.id}-${item.selectedVariantId ?? "base"}`} className="flex gap-3 rounded-lg border p-2 sm:p-0 sm:border-0">
                  ...
                  <div className="mt-2 flex items-center justify-between gap-2">
                    <div className="flex items-center">
                      <Button
                        ...
                        onClick={() => updateQuantity(item.id, item.quantity - 1, item.selectedVariantId ?? null)}
                      >
                    ...
                    <Button
                      ...
                      onClick={() => removeFromCart(item.id, item.selectedVariantId ?? null)}
                    >
